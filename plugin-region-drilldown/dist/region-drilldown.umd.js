/* OneEarth Region Drilldown v1.0.0 | Requires window.Cesium */
var OneEarthRegionDrilldown = (() => {
  ...
  __export(umd_exports, {
    createRegionDrilldown: () => createRegionDrilldown
  });
...
`;
  ...
  function createRegionDrilldownCore(Cesium, viewer, options) {
